...
public class EventViewModel {
	...
	private boolean hasSocioImpacts;
	...
	public boolean getHasSocioImpacts() {
		return hasSocioImpacts;
	}

	public void setHasSocioImpacts(boolean hasSocioImpacts) {
		this.hasSocioImpacts = hasSocioImpacts;
	}

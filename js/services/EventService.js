...
angular.module('risckit.eventService', []).
    service('EventService',  ['$http', '$upload', function ($http, $upload) {
        ...
        this.LoadEventsByCountries = function (fromYear, toYear, hasImpacts) {
            return this.m_oHttp({method: 'GET', url: this.APIURL + '/events/groupevent' + '/' + fromYear + '/' + toYear + '/' + hasImpacts});
        };
